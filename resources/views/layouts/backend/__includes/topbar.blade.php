<div id="kt_header" class="header header-fixed">
  <div class="container-fluid d-flex align-items-stretch justify-content-between">
    ...
    <div class="topbar">
      ...
      @include('layouts.backend.__includes.topbar.quickaction')
      @include('layouts.backend.__includes.topbar.cart')
      @include('layouts.backend.__includes.topbar.quickpanel')
